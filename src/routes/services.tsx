    ...
    <div className="overflow-x-hidden">
      <section className="bg-hero">
        <div className="container-px mx-auto max-w-7xl py-16 lg:py-24 text-center space-y-5">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display text-navy tracking-tight leading-tight">Specialist care, <span className="italic font-normal text-teal">tailored for you</span>.</h1>
          <p className="max-w-2xl mx-auto text-muted-foreground">17 specialist departments, advanced ICU, and 24×7 emergency — explore our complete range of services.</p>
        </div>
      </section>
            ...
            <Reveal key={d.slug} delay={(i % 3) * 80}>
              ...
              >
                ...
                <div className="relative">
                  <div className="grid place-items-center size-14 rounded-2xl bg-navy/5 text-navy group-hover:bg-navy group-hover:text-white transition-all duration-300 mb-5">
                    <DepartmentIcon name={d.icon} className="size-7" />
                  </div>
                  <h3 className="font-display text-xl text-navy font-bold">{d.name}</h3>
                  <p className="text-sm text-muted-foreground mt-2 leading-relaxed">{d.description}</p>
                  <div className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-teal group-hover:gap-2.5 transition-all">
